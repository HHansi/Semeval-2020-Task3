...
# Experiment setup before providing the baseline code
...
def get_similarity_measures(context1_vectors, context2_vectors):
    sim_context1 = get_cosine_similarity_sklearn(context1_vectors[0], context1_vectors[1])
    sim_context2 = get_cosine_similarity_sklearn(context2_vectors[0], context2_vectors[1])
